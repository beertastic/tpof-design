...
**He reads as a mercenary, not as a Jedi in disguise.**

An audience must be able to watch him for half the film without suspecting, then
...
- Layered technical cloth and worn synth-leather over a heavy work shirt.
- Padded jacket, re-shouldered at least once. Functional harness. Resoled boots.
...
- Small, jagged, **yellow**. Raw and uncut — not a finished saber crystal.
- Yellow marks the Sentinel: investigator, tracker, infiltrator. The one Jedi
  discipline that has actively kept him alive.
...
- A heavy rifle — his actual weapon. Battered, reliable, boring.
...
- Heavy, slow, deliberately unremarkable. He has practised being uninteresting.
- **Still in a way nobody else in the film is.** Scenes 3 and 19 turn on it.
- He does not kneel (Scene 19).
- He watches rooms — exits, sightlines, who is armed — and it looks like staring
  into space.
- Alone (Scene 14) he stops performing, and the change of gear must be visible.
- He does manual labour, badly rewarded, without complaint.
...
- **A visible lightsaber carrier.** There is no hilt on his belt. The blaster is
  the hilt.
- **A clean or tailored figure.** He is not the man from the later material yet;
  he has none of that authority, tailoring or bearing. He is nobody.
- Caribbean pirate, medieval, Victorian, Roman, or modern tactical/SWAT.
- Grey-haired-warrior cliché — the noble old fighter with a distinguished silver
  mane. He is going iron, badly cut, by his own hand.
- Too dark to separate from the night forest and camp firelight.
