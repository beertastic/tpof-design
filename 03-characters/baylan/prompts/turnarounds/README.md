...
|---|---|---|---|---|
| Working dress | **APPROVED** 2026-08-10 | FRONT | `turn-working-front.txt` | `turn-working-front.png` |
| Working dress | **APPROVED** 2026-08-10 | LEFT SIDE | `turn-working-left.txt` | `turn-working-left.png` |
| Working dress | **APPROVED** 2026-08-10 | RIGHT SIDE | `turn-working-right.txt` | `turn-working-right.png` |
| Working dress | **APPROVED** 2026-08-10 | BACK | `turn-working-back.txt` | `turn-working-back.png` |
| Working dress | **APPROVED** 2026-08-10 | NATURAL POSE | `turn-working-natural.txt` | `turn-working-natural.png` |
