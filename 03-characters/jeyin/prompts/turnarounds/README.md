...
|---|---|---|---|---|
| Domestic working clothes | in progress | FRONT | `turn-working-front.txt` | `turn-working-front.png` |
| Domestic working clothes | in progress | LEFT SIDE | `turn-working-left.txt` | `turn-working-left.png` |
| Domestic working clothes | in progress | RIGHT SIDE | `turn-working-right.txt` | `turn-working-right.png` |
| Domestic working clothes | in progress | BACK | `turn-working-back.txt` | `turn-working-back.png` |
| Domestic working clothes | in progress | NATURAL POSE | `turn-working-natural.txt` | `turn-working-natural.png` |
