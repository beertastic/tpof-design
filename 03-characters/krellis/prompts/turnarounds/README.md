...
|---|---|---|---|---|
| Arena medic's working gear | in progress | FRONT | `turn-working-front.txt` | `turn-working-front.png` |
| Arena medic's working gear | in progress | LEFT SIDE | `turn-working-left.txt` | `turn-working-left.png` |
| Arena medic's working gear | in progress | RIGHT SIDE | `turn-working-right.txt` | `turn-working-right.png` |
| Arena medic's working gear | in progress | BACK | `turn-working-back.txt` | `turn-working-back.png` |
| Arena medic's working gear | in progress | NATURAL POSE | `turn-working-natural.txt` | `turn-working-natural.png` |
