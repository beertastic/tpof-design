...
|---|---|---|---|---|
| Patrol armour, sealed | in progress | FRONT | `turn-sealed-front.txt` | `turn-sealed-front.png` |
| Patrol armour, sealed | in progress | LEFT SIDE | `turn-sealed-left.txt` | `turn-sealed-left.png` |
| Patrol armour, sealed | in progress | RIGHT SIDE | `turn-sealed-right.txt` | `turn-sealed-right.png` |
| Patrol armour, sealed | in progress | BACK | `turn-sealed-back.txt` | `turn-sealed-back.png` |
| Patrol armour, sealed | in progress | NATURAL POSE | `turn-sealed-natural.txt` | `turn-sealed-natural.png` |
| Patrol armour, helmet off | in progress | FRONT | `turn-unsealed-front.txt` | `turn-unsealed-front.png` |
| Patrol armour, helmet off | in progress | NATURAL POSE | `turn-unsealed-natural.txt` | `turn-unsealed-natural.png` |
