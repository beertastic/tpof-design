...
> 5 prompts, one costume. Generate those in full before any image in this
> document.
>
...
> `./tools/regen shada`** — all three generators, in one command. Running
