...
A flat six-sided plate about the width of two fingers. A **regular equilateral
...
**Four patches, four different materials.** Mismatched salvaged alloys — dull
...
**TESSELLATED, NOT OVERLAPPED.** The plates sit edge to edge, each separate, with
a narrow visible gap between it and its neighbours showing the dark backing
through. They do not lap over one another — no layering, no shingling, a single
flat plane. The flex comes from the gaps and the lacing.
...
Flat six-sided plates about the width of two fingers — **regular equilateral
...
Laced edge to edge with a narrow visible gap between neighbours showing the
backing through. No frame or bezel around any plate.
