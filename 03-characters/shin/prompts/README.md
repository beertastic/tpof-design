...
| `03-sky.txt` | `sky.png` | 9:16 | yes | yes |
| `04-camp_night.txt` | `camp_night.png` | 9:16 | yes | yes |
| `05-mother.txt` | `mother.png` | 9:16 | yes | yes |
| `06-detail_portrait.txt` | `detail_portrait.png` | 3:4 | — | yes |
| `07-vision_shadow.txt` | `vision_shadow.png` | 21:9 | yes | yes |
| `08-expression_strip.txt` | `expression_strip.png` | 16:9 | — | yes |
| `09-clasp.txt` | `clasp.png` | 3:1 | — | — |
| `10-hair_study.txt` | `hair_study.png` | 1:1 | — | — |
| `11-utility.txt` | `utility.png` | 1:1 | — | — |
| `12-ditch.txt` | `ditch.png` | 9:16 | yes | yes |
