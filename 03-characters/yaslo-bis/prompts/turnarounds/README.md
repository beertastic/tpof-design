...
|---|---|---|---|---|
| Working kit | in progress | FRONT | `turn-working-front.txt` | `turn-working-front.png` |
| Working kit | in progress | LEFT SIDE | `turn-working-left.txt` | `turn-working-left.png` |
| Working kit | in progress | RIGHT SIDE | `turn-working-right.txt` | `turn-working-right.png` |
| Working kit | in progress | BACK | `turn-working-back.txt` | `turn-working-back.png` |
| Working kit | in progress | NATURAL POSE | `turn-working-natural.txt` | `turn-working-natural.png` |
