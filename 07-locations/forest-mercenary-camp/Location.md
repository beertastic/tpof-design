---
title: "Forest Mercenary Camp"
asset_id: "LOC-FOREST-MERCENARY-CAMP"
version: "0.1"
status: "placeholder"
---

# Forest Mercenary Camp

> Refer to the Production Design Bible before all visual development.

> ## SPLIT IN TWO — decided 2026-08-01
>
> **The interior scenes moved onto the mercenary ship**, which is being built as
> a virtual set. This location is now the exterior half only.
>
> | Scene | Where it plays now |
> |---|---|
> | 9 — Jasu, the akk dog, the briefing | **Here.** Exterior, under a tarpaulin against a tree |
> | 10 — the Sabacc game | **`INT. MERCENARY SHIP - MAIN HOLD`** |
> | 13 — Baylan wakes | **`INT. MERCENARY SHIP - CREW BUNKS`** |
> | 14 — the storage area, Nyx on patrol | **Here.** Exterior, among the unloaded crates |
> | 15 — the crystal, the reconstruction | **`INT. MERCENARY SHIP - CREW BUNKS`** |
> | 19 — the morning muster | **Here.** Exterior, before they move out |
>
> See [`06-vehicles/mercenary-ship/`](../../06-vehicles/mercenary-ship/).
