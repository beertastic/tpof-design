...
| Captain Jasu | 1 | 5 | **2/5 — front APPROVED 2026-08-01** and locked in `outfits.yaml`; natural pose generated and matching. Left, right and back outstanding. They match against the approved front. Six reference plates attached: approved front, concept sketch, two figure shots for the headdress, the A180, the actor |
