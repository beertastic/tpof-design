...
|---|---|---|---|
| Shada | 1 | 5 | **1/5 current, and the design is LOCKED 2026-08-02.** Seven variant passes moved the vest from hide to **cloth**, the palette from brown to **grey / grey-green / khaki**, and fixed plate density, tessellation, cap size and wear. **The front is APPROVED** and is the single match target; the two direction photographs are retired. **17 images to regenerate** — run list in [`Shada-Image-TODO.md`](Shada-Image-TODO.md), starting with `scale_portrait` as a scoped **makeup** lock |
