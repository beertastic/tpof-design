...
|---|---|---|---|
| Shada | 1 | 5 | **0/5 current.** Third revision 2026-08-01 — flank panels restored, gauntlet a solid printed shell with wrist telltales, shoulder cap loose, vest carries a serpentine grain. Five pieces, five metals. The approved front is UNLOCKED and all five views are superseded. Two accepted reference photographs now attach to every prompt. Redo the front first |
