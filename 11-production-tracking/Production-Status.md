...
| Captain Jasu | 1 | 5 | **1/5 — front APPROVED 2026-08-01** and locked in `outfits.yaml`. Left, right, back and natural now match against it. Six reference plates attached: approved front, concept sketch, two figure shots for the headdress, the A180, the actor |
