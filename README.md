...
| [`09-prompt-library/ChatGPT-Project-Instructions.md`](09-prompt-library/ChatGPT-Project-Instructions.md) | **The text to paste into ChatGPT's project settings.** Master copy — the live one is in ChatGPT |
